...
public class ValorFormChangeParticle extends AbstractGameEffect {
    ...
    public ValorFormChangeParticle(float playerX) {
        this(playerX, null);
    }


    public ValorFormChangeParticle(float playerX, Color color) {
        if (color == null)
        {
            this.color = ValorForm.getColor(0.0F);
        } else {
            this.color = color;
        }
