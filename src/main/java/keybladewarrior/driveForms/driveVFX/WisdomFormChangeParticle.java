...
public class WisdomFormChangeParticle extends AbstractGameEffect {
    ...
    public WisdomFormChangeParticle(float playerX) {
        this(playerX, null);
    }


    public WisdomFormChangeParticle(float playerX, Color color) {
        if (color == null)
        {
            this.color = WisdomForm.getColor(0.0F);
        } else {
            this.color = color;
        }
