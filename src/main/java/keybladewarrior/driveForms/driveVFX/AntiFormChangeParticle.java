...
public class AntiFormChangeParticle extends AbstractGameEffect {
    ...
    public AntiFormChangeParticle(float playerX) {
        this(playerX, null);
    }


    public AntiFormChangeParticle(float playerX, Color color) {
        if (color == null)
        {
            this.color = AntiForm.getColor(0.0F);
        } else {
            this.color = color;
        }
