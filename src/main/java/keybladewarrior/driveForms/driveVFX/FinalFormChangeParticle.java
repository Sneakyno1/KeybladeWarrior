...
public class FinalFormChangeParticle extends AbstractGameEffect {
    ...
    public FinalFormChangeParticle(float playerX) {
        this(playerX, null);
    }


    public FinalFormChangeParticle(float playerX, Color color) {
        if (color == null)
        {
            this.color = FinalForm.getColor(0.0F);
        } else {
            this.color = color;
        }
