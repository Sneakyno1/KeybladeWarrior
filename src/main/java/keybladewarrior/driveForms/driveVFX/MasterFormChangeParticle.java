...
public class MasterFormChangeParticle extends AbstractGameEffect {
    ...
    public MasterFormChangeParticle(float playerX) {
        this(playerX, null);
    }


    public MasterFormChangeParticle(float playerX, Color color) {
        if (color == null)
        {
            this.color = MasterForm.getColor(0.0F);
        } else {
            this.color = color;
        }
