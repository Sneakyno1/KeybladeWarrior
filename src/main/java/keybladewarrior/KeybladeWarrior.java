...
public class KeybladeWarrior extends CustomPlayer {
    ...
    public KeybladeWarrior(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new KeybladeWarrior(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass KeybladeWarrior;
        @SpireEnum(name = "MIDNIGHT")
